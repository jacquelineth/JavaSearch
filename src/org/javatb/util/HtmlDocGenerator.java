...
public class HtmlDocGenerator
{
   ...
   */
  private String processTemplateCall(final String templateCall, final Map<String, String> callerMap, String templateFolder)
      throws Exception
      {
   ...
   * @throws Exception if an error occurs while parsing the template or building its instance.
   */
  private String processParameters(final Map<String, String> parameterMap, final String content) throws Exception
  {
  ...
  public static void main(final String...args)
  {
    try
    {
      ...
      System.out.println("Generating web pages:");
      System.out.println("     source dir: " + args[0]);
      System.out.println("     target dir: " + args[1]);
      System.out.println("  templates dir: " + args[2]);
      ...
      System.out.println("Pages successfully generated");
    }
    catch(Exception e)
    {
      e.printStackTrace();
