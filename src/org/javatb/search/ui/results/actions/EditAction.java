...
/**
 * Action for editing the selected results using their associated applications.
 * @author Laurent Cohen
 */
public class EditAction extends AbstractResultAction
{
  /**
   * Initialize this action.
   */
  public EditAction(final ResultRenderer renderer)
  {
    super(renderer);
